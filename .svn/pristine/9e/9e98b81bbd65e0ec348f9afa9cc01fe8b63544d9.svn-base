...
public class ZoneValveController {
    ...
    public @ResponseBody Map<String,Object> roomValveList(@RequestParam Map map){
        try {
            ...
            for(int i=0;i<list.size();i++){
                ...
                //温度-1状态为--
                String set_temp=String.valueOf(roomValve.get("set_temp"));
                if(set_temp.equals("-1.00")){
                    roomValve.put("set_temp","-");
                }
                String room_temp=String.valueOf(roomValve.get("room_temp"));
                if(room_temp.equals("-1.00")){
                    roomValve.put("room_temp","-");
                }
                String in_temp=String.valueOf(roomValve.get("in_temp"));
                if(in_temp.equals("-1.00")){
                    roomValve.put("in_temp","-");
                }
                String out_temp=String.valueOf(roomValve.get("out_temp"));
                if(out_temp.equals("-1.00")){
                    roomValve.put("out_temp","-");
                }
                //房间号
    ...
    @RequestMapping("roomValveInfoPage")
    @RequiresPermissions("sysIndex")
